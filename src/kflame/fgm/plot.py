...
Uso:
  python -m kflame plot --run-dir runs/fgm/mi_run
  python -m kflame plot --run-dir runs/fgm/mi_run --sp1 CO2 --sp2 OH
  python -m kflame plot --run-dir runs/fgm/mi_run --log-scale
"""
...
def plot_hrr_heatmap_ZC(
    ...
    if "Z_grid" in table:
        ...
        y_label = r"$\phi$"
        warnings.warn("Z_grid no encontrado; usando phi_grid. Regenera con generador kflame.")
