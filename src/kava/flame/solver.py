...
from kava.flame.equations import (
...
from kava.flame.state import build_transient_mask, interpolate_state, pack_state, unpack_state
...
def newton_solve(
    ...
    def full_fun(xv: np.ndarray) -> np.ndarray:
        from kava.flame.equations import residual as _res
        return _res(
            xv,
            problem,
            rdt=rdt,
