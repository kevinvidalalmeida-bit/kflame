...
from kava.reference.plot import generate_clean_plots
from kava.flame.problem import FreeFlameProblem
from kava.flame.solver import SolveOptions, solve_free_flame
from kava.flame.state import unpack_state
...
def _v2_solve(
    ...
    from kava.chemistry.mechanism import load_mechanism  # type: ignore
    from kava.chemistry.backend import NativeSpeciesBackend  # type: ignore
