...
Lee fgm_table.npz generado por generate_fgm_tables_cantera.py (v2)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        help="Ruta al archivo fgm_table.npz generado por generate_fgm_tables_cantera.py",
    )
    p.add_argument(
...
def main() -> None:
    ...
    print(f"  Para OpenFOAM   : copia fgm_table_full.fla a constant/")
    print(f"  Para Fluent     : importar como flamelet table en el panel Species")
    print("-" * 65)
