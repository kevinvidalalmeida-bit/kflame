...
Post-procesa tablas FGM generadas por generate_fgm_tables_cantera.py (v2)
...
Uso:
  python plot_fgm_figures.py --run-dir fgm_runs/mi_run
  python plot_fgm_figures.py --run-dir fgm_runs/mi_run --sp1 CO2 --sp2 OH
  python plot_fgm_figures.py --run-dir fgm_runs/mi_run --log-scale
"""
...
def plot_species_profiles(
    ...
    for idx, rec in enumerate(recs):
        ...
        try:
            ...
            warnings.warn(f"Especie {sp} no en phi={rec['phi']:.3f}")
            continue
