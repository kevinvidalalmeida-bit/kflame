"""Summarize supplied native integration outputs without importing Cantera.

Use with tests/no_cantera on PYTHONPATH. Raw profiles remain in their run
...
def main():
    ...
    sources = sorted((ROOT / 'src/kflame').rglob('*.py'))
